...
public interface INumericVector<T, TNumber> : IAdditionOperators<T, T, T>, IAdditiveIdentity<T, T>, ISubtractionOperators<T, T, T>, IMultiplyOperators<T, TNumber, T>, IDivisionOperators<T, TNumber, T>, IEquatable<T>, IEqualityOperators<T, T, bool>
